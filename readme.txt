...
> **Support policy**
>
> * Should you need assistance, please open a support request in the **[Support section, above](http://wordpress.org/support/plugin/woocommerce-skrill-moneybookers-gateway)**, and we will look into it as soon as possible (usually within a couple of days).
> * If you need support urgently, or you require a customisation, you can avail of our paid support and consultancy services. To do so, please contact us [using our dedicated portal](https://aelia.freshdesk.com/helpdesk/tickets/new), specifying that you are using our WooCommerce Skrill plugin. You will receive direct assistance from our team, who will troubleshoot your site and help you to make it work smoothly. We can also help you with installation, customisation and development of new features.
...
= Requirements =
* A Skrill Merchant account. The plugin was not tested with personal accounts and might not work correctly with them.
* WordPress 3.6 or later
* PHP 5.3 or later
* WooCommerce 2.4.x to 3.0.x
* [Aelia Foundation Classes plugin for WooCommerce](http://bit.ly/WC_AFC_S3) 1.0.10.140819 or later.
...
= 1.4.1.160413 =
* Updated supported WordPress version to 4.5.

= 1.4.0.160228 =
* Fixed minor rendering issues in payment page.
* Fixed reference to text domain in Skrill gateway class.

= 1.3.2.151130 =
* Fixed initialisation of Messages controller. The controller now uses the correct text domain.

= 1.3.1.151017 =
* Fixed minor notice messages in the receipt page.
* Fixed country code for Isle of Man.
* Fixed logic to determine if the test gateway should be used.

= 1.3.0.150924 =
* Improved support for multisite configurations:
	* Replaced order ID with order number.
	* Added order ID as extra data, for validation of payment response.
